...
Проверить, что фото и имя изменились.
...
Указать, что у команды есть дубль, сохранить, - получить совмещение составов и заявок. Проверить, что составы совместились, для этого нажать на команду, и посмотреть на список игроков в ней. Проверить, что заявки совместились???
Проверить, что ставятся и снимаются галочка в пункте “показывать на сайте/приложении”. 
